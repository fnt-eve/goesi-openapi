...
// checks if the FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner{}

// FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner last_week object
type FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner struct {
...
func NewFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner() *FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner {
	this := FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner{}
	return &this
}
...
func (o FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) MarshalJSON() ([]byte, error) {
...
func (o FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) ToMap() (map[string]interface{}, error) {
...
type NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner struct {
	value *FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner
	isSet bool
}

func (v NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) Get() *FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner {
	return v.value
}

func (v *NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) Set(val *FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner(val *FwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) *NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner {
	return &NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner{value: val, isSet: true}
}

func (v NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFwLeaderboardsCorporationsGetVictoryPointsLastWeekInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
