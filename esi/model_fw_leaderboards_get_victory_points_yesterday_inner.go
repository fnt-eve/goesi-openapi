...
// checks if the FwLeaderboardsGetVictoryPointsYesterdayInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FwLeaderboardsGetVictoryPointsYesterdayInner{}

// FwLeaderboardsGetVictoryPointsYesterdayInner yesterday object
type FwLeaderboardsGetVictoryPointsYesterdayInner struct {
...
func NewFwLeaderboardsGetVictoryPointsYesterdayInner() *FwLeaderboardsGetVictoryPointsYesterdayInner {
	this := FwLeaderboardsGetVictoryPointsYesterdayInner{}
	return &this
}
...
func (o FwLeaderboardsGetVictoryPointsYesterdayInner) MarshalJSON() ([]byte, error) {
...
func (o FwLeaderboardsGetVictoryPointsYesterdayInner) ToMap() (map[string]interface{}, error) {
...
type NullableFwLeaderboardsGetVictoryPointsYesterdayInner struct {
	value *FwLeaderboardsGetVictoryPointsYesterdayInner
	isSet bool
}

func (v NullableFwLeaderboardsGetVictoryPointsYesterdayInner) Get() *FwLeaderboardsGetVictoryPointsYesterdayInner {
	return v.value
}

func (v *NullableFwLeaderboardsGetVictoryPointsYesterdayInner) Set(val *FwLeaderboardsGetVictoryPointsYesterdayInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFwLeaderboardsGetVictoryPointsYesterdayInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFwLeaderboardsGetVictoryPointsYesterdayInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFwLeaderboardsGetVictoryPointsYesterdayInner(val *FwLeaderboardsGetVictoryPointsYesterdayInner) *NullableFwLeaderboardsGetVictoryPointsYesterdayInner {
	return &NullableFwLeaderboardsGetVictoryPointsYesterdayInner{value: val, isSet: true}
}

func (v NullableFwLeaderboardsGetVictoryPointsYesterdayInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFwLeaderboardsGetVictoryPointsYesterdayInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
