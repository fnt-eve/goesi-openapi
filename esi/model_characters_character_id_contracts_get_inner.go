...
// checks if the CharactersCharacterIdContractsGetInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CharactersCharacterIdContractsGetInner{}

// CharactersCharacterIdContractsGetInner struct for CharactersCharacterIdContractsGetInner
type CharactersCharacterIdContractsGetInner struct {
...
type _CharactersCharacterIdContractsGetInner CharactersCharacterIdContractsGetInner
...
func NewCharactersCharacterIdContractsGetInner(acceptorId int64, assigneeId int64, availability string, contractId int64, dateExpired time.Time, dateIssued time.Time, forCorporation bool, issuerCorporationId int64, issuerId int64, status string, type_ string) *CharactersCharacterIdContractsGetInner {
	this := CharactersCharacterIdContractsGetInner{}
...
func (o CharactersCharacterIdContractsGetInner) MarshalJSON() ([]byte, error) {
...
func (o CharactersCharacterIdContractsGetInner) ToMap() (map[string]interface{}, error) {
...
func (o *CharactersCharacterIdContractsGetInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCharactersCharacterIdContractsGetInner := _CharactersCharacterIdContractsGetInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCharactersCharacterIdContractsGetInner)

	if err != nil {
		return err
	}

	*o = CharactersCharacterIdContractsGetInner(varCharactersCharacterIdContractsGetInner)

	return err
}

type NullableCharactersCharacterIdContractsGetInner struct {
	value *CharactersCharacterIdContractsGetInner
	isSet bool
}

func (v NullableCharactersCharacterIdContractsGetInner) Get() *CharactersCharacterIdContractsGetInner {
	return v.value
}

func (v *NullableCharactersCharacterIdContractsGetInner) Set(val *CharactersCharacterIdContractsGetInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCharactersCharacterIdContractsGetInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCharactersCharacterIdContractsGetInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCharactersCharacterIdContractsGetInner(val *CharactersCharacterIdContractsGetInner) *NullableCharactersCharacterIdContractsGetInner {
	return &NullableCharactersCharacterIdContractsGetInner{value: val, isSet: true}
}

func (v NullableCharactersCharacterIdContractsGetInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCharactersCharacterIdContractsGetInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
