...
// checks if the FwLeaderboardsCharactersGetKillsLastWeekInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FwLeaderboardsCharactersGetKillsLastWeekInner{}

// FwLeaderboardsCharactersGetKillsLastWeekInner last_week object
type FwLeaderboardsCharactersGetKillsLastWeekInner struct {
	// Amount of kills
...
func NewFwLeaderboardsCharactersGetKillsLastWeekInner() *FwLeaderboardsCharactersGetKillsLastWeekInner {
	this := FwLeaderboardsCharactersGetKillsLastWeekInner{}
	return &this
}
...
func (o FwLeaderboardsCharactersGetKillsLastWeekInner) MarshalJSON() ([]byte, error) {
...
func (o FwLeaderboardsCharactersGetKillsLastWeekInner) ToMap() (map[string]interface{}, error) {
...
type NullableFwLeaderboardsCharactersGetKillsLastWeekInner struct {
	value *FwLeaderboardsCharactersGetKillsLastWeekInner
	isSet bool
}

func (v NullableFwLeaderboardsCharactersGetKillsLastWeekInner) Get() *FwLeaderboardsCharactersGetKillsLastWeekInner {
	return v.value
}

func (v *NullableFwLeaderboardsCharactersGetKillsLastWeekInner) Set(val *FwLeaderboardsCharactersGetKillsLastWeekInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFwLeaderboardsCharactersGetKillsLastWeekInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFwLeaderboardsCharactersGetKillsLastWeekInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFwLeaderboardsCharactersGetKillsLastWeekInner(val *FwLeaderboardsCharactersGetKillsLastWeekInner) *NullableFwLeaderboardsCharactersGetKillsLastWeekInner {
	return &NullableFwLeaderboardsCharactersGetKillsLastWeekInner{value: val, isSet: true}
}

func (v NullableFwLeaderboardsCharactersGetKillsLastWeekInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFwLeaderboardsCharactersGetKillsLastWeekInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
